package com.mansion.yang.mixtureapp.widget.datapicker;

import android.os.Debug;
import android.os.Environment;
import android.util.Log;

import com.mansion.yang.mixtureapp.Constant;
...
public final class LogUtils {
    ...
    private static boolean isDebug = Constant.DEBUG_ENABLE;// 是否调试模式
    private static String debugTag = Constant.DEBUG_TAG;// LogCat的标记
